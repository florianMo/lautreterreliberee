...
<Title2>La «Basconnaise», salade composite, complète, d’infinie variété</Title2>
<Paragraph>
...
<Paragraph>
    La méthode d’infinie variété a pour avantage, le premier, de ne plus avoir à se préoccuper de rechercher l’exacte nature et le véritable effet de tel ou tel aliment, réputé excellent par les uns, et proclamé dangereux par les autres. S’il fallait écouter les avis des «spécialistes» de la science alimentaire, on ne pourrait plus toucher à un aucun aliment : ils les ont tous condamnés.
</Paragraph>
<Paragraph>
...
<Paragraph>
    Un tel examen, un tel contrôle, sont-ils possible, même au médecin, au chimiste ?</Paragraph>
<Paragraph>
...
<Paragraph>
    Les racines crues : carottes, navets, rutabagas, radis noirs, panais, raves, betteraves, pommes de terre, topinambours, etc., simplement brossés - un légume, un fruit épluchés perdent jusqu’à 8 parties sur 10 de leur valeur nourricière - sans être épluchés, il seront donc nettoyés à la brosse à main dans l’eau courante, si possible, et coupés par le travers du fruit - afin que le fil soit coupé menu - avec un couteau de fer blanc, dit «couteau à la julienne», vendu communément 0 fr. 50 dans les bazars. Ce couteau, garni de petites encoches, produit une julienne qui fait s’entrelacer, dans un coloris appétissant, puis se confondre, tous les éléments en présence.
</Paragraph>
<Paragraph>
...
<Paragraph>
    Et nous répondrons à cela, que l'argument ne porte que pour ceux qui n'ont pas de temps, soit qu'ils le gâchent ou qu'ils l'offrent stupidement à la rapacité de ceux qui les dupent ou les exploitent.</Paragraph>
<Paragraph>
...
<Title2>Pot-au-feu végétalien</Title2>
<Paragraph>
...
<Paragraph>
    Ajouter dans l’ordre, suivant saison : salsifis, pommes de terre, une pomme ou deux coupées en rondelles, potiron ou tomate, asperges, et en dernier : oseille, un cœur de chou étincelé, persil et cerfeuil.
</Paragraph>
<Paragraph>
...
<Title2>La choucroute végétalienne</Title2>
<Paragraph>
